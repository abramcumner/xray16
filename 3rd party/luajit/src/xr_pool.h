...
// Как вариант попробую выделить большой кусок памяти(128+128МБ) в начале игры и буду его потихоньку выдавать луаджиту
// Использую для этого аналог сталкерского poolSS
