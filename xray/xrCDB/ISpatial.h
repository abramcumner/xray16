...
public:
    ...
    BOOL _empty()
    {
        return items.empty() && children[0] == nullptr && children[1] == nullptr && children[2] == nullptr &&
            children[3] == nullptr && children[4] == nullptr && children[5] == nullptr && children[6] == nullptr &&
            children[7] == nullptr;
    }
};
////////////
