    ...
    ptPatchCallback callback, PTBool blocking, void* instance)
{
    ...
    return ptCheckForPatchA(GAMESPY_PRODUCTID,
               ...
               GetGameDistribution(), callback, blocking, instance) != PTFalse;
};

XRGAMESPY_API bool xrGS_ptTrackUsageA(int userID)
{
    return ptTrackUsageA(userID, GAMESPY_PRODUCTID, GetGameVersion(), GetGameDistribution(), PTFalse) != PTFalse;
}