...
//	EXPORT_FN_DECL(ServerBrowser, ServerBrowserNew, (const gsi_char *queryForGamename, const gsi_char
...
//	EXPORT_FN_DECL(SBError, ServerBrowserUpdate, (ServerBrowser sb, SBBool async, SBBool disconnectOnComplete, const
//unsigned char *basicFields, int numBasicFields, const gsi_char *serverFilter));
EXPORT_FN_DECL(SBError, ServerBrowserUpdateA,
    (ServerBrowser sb, SBBool async, SBBool disconnectOnComplete, const gsi_char* serverFilter));

//	EXPORT_FN_DECL(SBError, ServerBrowserLANUpdate, (ServerBrowser sb, SBBool async, unsigned short startSearchPort,
...
EXPORT_FN_DECL(SBError, ServerBrowserAuxUpdateIPA,
    (ServerBrowser sb, const gsi_char* ip, unsigned short port, SBBool viaMaster, SBBool async, SBBool fullUpdate));

EXPORT_FN_DECL(const gsi_char*, SBServerGetPlayerStringValueA,
...
EXPORT_FN_DECL(
    double, SBServerGetPlayerFloatValueA, (SBServer server, int playernum, const gsi_char* key, double fdefault));

EXPORT_FN_DECL(const gsi_char*, SBServerGetTeamStringValueA,
...
EXPORT_FN_DECL(
    double, SBServerGetTeamFloatValueA, (SBServer server, int teamnum, const gsi_char* key, double fdefault));
...
EXPORT_FN_DECL(
    SBBool, SBServerGetConnectionInfo, (ServerBrowser sb, SBServer server, gsi_u16 PortToConnectTo, char* ipstring));
