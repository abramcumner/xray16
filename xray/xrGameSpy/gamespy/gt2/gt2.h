...
GT2Result gt2CreateSocket(
    ...
    int outgoingBufferSize, // size of per-connection buffer where sent messages waiting to be confirmed are held, use 0
                            // for default
...
// Before using these, read the comments for the gt2*ToHostInfo() functions, as the info also applies to these
// functions.
