    ...
    else if (UTF8_IS_THREE_BYTE(theUTF8String[0]))
    {
        ...
        if (UTF8_IS_FOLLOW_BYTE(theUTF8String[1]) && UTF8_IS_FOLLOW_BYTE(theUTF8String[2]))
        {
            ...
            *theUnicodeChar = (unsigned short)(((theUTF8String[0] & UTF8_THREE_BYTE_MASK) << 12) +
                ((theUTF8String[1] & UTF8_FOLLOW_BYTE_MASK) << 6) + ((theUTF8String[2] & UTF8_FOLLOW_BYTE_MASK)));
            return 3;
        }
    }
...
int _UCS2CharToUTF8String(UCS2Char theUCS2Char, UTF8String theUTF8String)
{
    ...
    else if (theUCS2Char <= 0x07FF)
    {
        ...
        theUTF8String[1] = (char)(UTF8ByteType)(UTF8_FOLLOW_BYTE_TAG |
            (theUCS2Char & UTF8_FOLLOW_BYTE_MASK)); // Store the lower 6 bits as 0x10xxxxxx
        return 2;
    }
    else
    {
        ...
        theUTF8String[2] = (char)(UTF8ByteType)(UTF8_FOLLOW_BYTE_TAG |
            ((theUCS2Char)&UTF8_FOLLOW_BYTE_MASK)); // Store the last 6 bits as 0x10xxxxxx
        return 3;
    }
}
