...
static GHTTPBool gsiSoapTaskHttpCompletedCallback(
...
GSSoapTask* gsiExecuteSoap(const char* theURL, const char* theService, GSXmlStreamWriter theRequestSoap,
...
GSSoapTask* gsiExecuteSoapCustom(const char* theURL, const char* theService, GSXmlStreamWriter theRequestSoap,
...
static void gsiSoapTaskExecute(void* theTask)
{
    ...
    aSoapTask->mRequestId = ghttpGetExA(aSoapTask->mURL, aSoapTask->mService, NULL, 0, aSoapTask->mPostData, GHTTPFalse,
        GHTTPFalse, NULL, gsiSoapTaskHttpCompletedCallback, (void*)aSoapTask);
}
