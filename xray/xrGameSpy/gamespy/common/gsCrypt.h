...
//           SignFirst: Decryption must take place before the signature is validated.  This is a high overhead for
//           invalid signatures. EncryptFirst: Signature validation takes place before decryption, but the MAC is
//           unencrypted to packet sniffers.  (Exposes it to attack)
