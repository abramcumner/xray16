...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult sciWsCreateSession(SCWebServices* theWebServices, gsi_u32 theGameId, const GSLoginCertificate* theCertificate,
    ...
    void* theUserData)
{
    ...
    if (gsi_is_false(gsXmlWriteOpenTag(aRequest, "gsc", "CreateSession")) ||
        ...
        gsi_is_false(gsXmlWriteCloseTag(aRequest, "gsc", "CreateSession")) || gsi_is_false(gsXmlCloseWriter(aRequest)))
    {
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult sciWsCreateMatchlessSession(SCWebServices* theWebServices, gsi_u32 theGameId,
...
void sciWsCreateSessionCallback(
    GHTTPResult theHttpResult, GSXmlStreamWriter theRequestData, GSXmlStreamReader theResponseData, void* theUserData)
{
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult sciWsSetReportIntention(SCWebServices* theWebServices, gsi_u32 theGameId, const char* theSessionId,
    const char* theConnectionId, gsi_bool isAuthoritative, const GSLoginCertificate* theCertificate,
    const GSLoginPrivateData* thePrivateData, SCSetReportIntentionCallback theCallback, gsi_time theTimeoutMs,
    void* theUserData)
{
    GSXmlStreamWriter aRequest = NULL;
...
extern GHTTPBool ghiPostAddFileFromMemory(GHTTPPost post, const char* name, const char* buffer, int bufferLen,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult sciWsSubmitReport(SCWebServices* theWebServices, gsi_u32 theGameId, const char* theSessionId,
    const char* theConnectionId, const SCIReport* theReport, gsi_bool isAuthoritative,
    const GSLoginCertificate* theCertificate, const GSLoginPrivateData* thePrivateData,
    SCSubmitReportCallback theCallback, gsi_time theTimeoutMs, void* theUserData)
{
    ...
    if (gsi_is_false(gsXmlWriteOpenTag(aRequest, "gsc", "SubmitReport")) ||
        ...
        gsi_is_false(
            gsXmlWriteIntElement(aRequest, "gsc", "authoritative", (gsi_u32)(gsi_is_true(isAuthoritative) ? 1 : 0))) ||
        gsi_is_false(gsXmlWriteCloseTag(aRequest, "gsc", "SubmitReport")) || gsi_is_false(gsXmlCloseWriter(aRequest)))
    {
        gsXmlFreeWriter(aRequest);
        return SCResult_OUT_OF_MEMORY;
    }
    ...
    // Execute soap call
    gsiExecuteSoapCustom(scServiceURL, SC_SUBMITREPORT_SOAPACTION, aRequest, sciWsSubmitReportCallback,
        sciWsSubmitReportCustom, theWebServices);
    ...
    GHTTPResult theHttpResult, GSXmlStreamWriter theRequestData, GSXmlStreamReader theResponseData, void* theUserData)
{
    ...
    if (theHttpResult == GHTTPSuccess)
    {
        ...
        else
        {
            switch (submitResult)
            {
            case SCWsResult_NO_ERROR: aTranslatedResult = SCResult_NO_ERROR; break;
            case SCWsResult_REPORT_INVALID: aTranslatedResult = SCResult_REPORT_INVALID; break;
            case SCWsResult_SINGLE_ATTACHMENT_EXPECTED: aTranslatedResult = SCResult_SUBMISSION_FAILED; break;
            default: aTranslatedResult = SCResult_UNKNOWN_RESPONSE; break;
            };
        }
    }
    else
