...
// "matchless" means incoming data will be scrutinized less, and applied to stats immediately instead of when the match
// is over.
...
SCResult SC_CALL scCreateReport(const SCInterfacePtr theInterface, gsi_u32 theHeaderVersion, gsi_u32 thePlayerCount,
    gsi_u32 theTeamCount, SCReportPtr* theReportOut);
...
SCResult SC_CALL scReportSetPlayerData(SCReportPtr theReport, gsi_u32 thePlayerIndex,
    ...
    gsi_u32 theProfileId, const GSLoginCertificate* theCertificate, const gsi_u8 theAuthData[16]);
