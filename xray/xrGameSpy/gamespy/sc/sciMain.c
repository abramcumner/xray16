...
SCResult SC_CALL scCreateSession(SCInterfacePtr theInterface, const GSLoginCertificate* theCertificate,
    ...
    void* theUserData)
{
    ...
    return sciWsCreateSession(&anInterface->mWebServices, anInterface->mGameId, theCertificate, thePrivateData,
        theCallback, theTimeoutMs, theUserData);
}

///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL scCreateMatchlessSession(SCInterfacePtr theInterface, const GSLoginCertificate* theCertificate,
    const GSLoginPrivateData* thePrivateData, SCCreateSessionCallback theCallback, gsi_time theTimeoutMs,
    void* theUserData)
{
    SCInterface* anInterface = (SCInterface*)theInterface;
    ...
    return sciWsCreateMatchlessSession(&anInterface->mWebServices, anInterface->mGameId, theCertificate, thePrivateData,
        theCallback, theTimeoutMs, theUserData);
}
    ...
    SCSetReportIntentionCallback theCallback, gsi_time theTimeoutMs, void* theUserData)
{
    ...
    // Call web service
    return sciWsSetReportIntention(&anInterface->mWebServices, anInterface->mGameId, (char*)anInterface->mSessionId,
        (char*)anInterface->mConnectionId, isAuthoritative, theCertificate, thePrivateData, theCallback, theTimeoutMs,
        theUserData);
}

///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL scSubmitReport(const SCInterfacePtr theInterface, const SCReportPtr theReport,
    ...
    SCSubmitReportCallback theCallback, gsi_time theTimeoutMs, void* theUserData)
{
    ...
    // Call web service
    return sciWsSubmitReport(&anInterface->mWebServices, anInterface->mGameId, (char*)anInterface->mSessionId,
        (char*)anInterface->mConnectionId, aReport, isAuthoritative, theCertificate, thePrivateData, theCallback,
        theTimeoutMs, theUserData);
}

///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL scCreateReport(const SCInterfacePtr theInterface, gsi_u32 theHeaderVersion, gsi_u32 thePlayerCount,
    gsi_u32 theTeamCount, SCReportPtr* theReportDataOut)
{
    SCResult aResult = SCResult_NO_ERROR;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL scReportSetPlayerData(SCReportPtr theReport, gsi_u32 thePlayerIndex,
...
SCResult SC_CALL scPeerCipherCreateKeyExchangeMsg(
    const GSLoginCertificate* theRemoteCert, const SCPeerCipher* theCipher, SCPeerKeyExchangeMsg theMsgOut)
{
...
SCResult SC_CALL scPeerCipherParseKeyExchangeMsg(const GSLoginCertificate* theLocalCert,
    const GSLoginPrivateData* theCertPrivateData, const SCPeerKeyExchangeMsg theMsg, SCPeerCipher* theCipherOut)
{
            ...
            &theCertPrivateData->mPeerPrivateKey, (unsigned char*)theMsg, theCipherOut->mKey, &theCipherOut->mKeyLen))
    {
        ...
        gsDebugBinary(GSIDebugCat_App, GSIDebugType_Misc, GSIDebugLevel_Notice, (char*)theCipherOut->mKey,
