...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL sciCreateReport(gsi_u8 theSessionGuid[SC_SESSION_GUID_SIZE], gsi_u32 theHeaderVersion,
    gsi_u32 thePlayerCount, gsi_u32 theTeamCount, SCIReport** theReportOut)
{
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL sciReportSetPlayerConnectionId(
    SCIReport* theReport, gsi_u32 thePlayerIndex, const gsi_u8 theConnectionId[SC_CONNECTION_GUID_SIZE])
{
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL sciReportSetPlayerAuthInfo(SCIReport* theReport, gsi_u32 thePlayerIndex,
    const GSLoginCertificate* theCertificate, const gsi_u8 theAuthHash[16])
{
    SCIReportHeader* aHeader = (SCIReportHeader*)theReport->mBuffer.mData;
...
//	rosterDataOffset += SC_CONNECTION_GUID_SIZE;
    ...
    // Write auth data
    //result = wsLoginCertWriteBinary(theCertificate, &theReport->mBuffer.mData[theReport->mBuffer.mPos],
(SC_REPORT_BUFFER_BYTES - theReport->mBuffer.mPos), &len);
...
SCResult SC_CALL sciReportBeginNewTeam(SCIReport* theReport)
{
    ...
    sciSerializeInt16(
        (gsi_u8*)&theReport->mBuffer.mData[theReport->mCurEntityStartPos], (gsi_i16)theReport->mCurEntityKeyCount);
...
SCResult SC_CALL sciReportBeginTeamData(SCIReport* theReport)
{
    ...
    // Must not have passed into player data state yet.
    GS_ASSERT(theReport->mReportState == SCIReportState_ROSTER ||
        theReport->mReportState == SCIReportState_GLOBALDATA || theReport->mReportState == SCIReportState_PLAYERDATA);
