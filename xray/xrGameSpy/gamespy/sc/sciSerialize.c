...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
gsi_u8* sciSerializeKey(gsi_u8* theCursor, gsi_u16 theKey) { return sciSerializeInt16(theCursor, (gsi_i16)theKey); }
...
gsi_u8* sciSerializeGUID(gsi_u8* theCursor, const gsi_u8 theGUID[SC_CONNECTION_GUID_SIZE])
{
    ...
    sscanf((char*)theGUID + 24, "%2x%2x%2x%2x%2x%2x", &aIntArray[2], &aIntArray[3], &aIntArray[4], &aIntArray[5],
