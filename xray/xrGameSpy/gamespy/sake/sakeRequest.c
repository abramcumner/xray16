...
static SAKERequestResult SAKE_CALL sakeiCheckHttpResult(GHTTPResult httpResult)
{
    switch (httpResult)
    {
    case GHTTPSuccess: return SAKERequestResult_SUCCESS;
    case GHTTPOutOfMemory: return SAKERequestResult_OUT_OF_MEMORY;
    default: return SAKERequestResult_CONNECTION_ERROR;
    }
}
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static void SAKE_CALL sakeiSoapCallback(
    GHTTPResult httpResult, GSXmlStreamWriter requestData, GSXmlStreamReader responseData, void* userData)
{
    ...
    if (result == SAKERequestResult_SUCCESS)
    {
        if (gsi_is_false(gsXmlMoveToStart(responseData)) ||
            ...
            gsi_is_false(
                gsXmlReadChildAsStringNT(responseData, request->mInfo->mResultTag, resultString, sizeof(resultString))))
        {
