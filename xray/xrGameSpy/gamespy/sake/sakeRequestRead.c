...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static SAKERequestResult SAKE_CALL sakeiReadOutputRecords(
    SAKERequest request, SAKEField*** outputRecordsPtr, int* numRecords, int numFields, char** fieldNames)
...
{
    static SAKEIRequestInfo info = {sizeof(SAKESearchForRecordsOutput), SAKEI_FUNC_NAME_STRINGS("SearchForRecords"),
        sakeiSearchForRecordsValidateInput, sakeiSearchForRecordsFillSoapRequest,
        sakeiSearchForRecordsProcessSoapResponse, sakeiSearchForRecordsFreeData};
...
{
    static SAKEIRequestInfo info = {sizeof(SAKEGetMyRecordsOutput), SAKEI_FUNC_NAME_STRINGS("GetMyRecords"),
...
{
    static SAKEIRequestInfo info = {sizeof(SAKEGetSpecificRecordsOutput), SAKEI_FUNC_NAME_STRINGS("GetSpecificRecords"),
        sakeiGetSpecificRecordsValidateInput, sakeiGetSpecificRecordsFillSoapRequest,
        sakeiGetSpecificRecordsProcessSoapResponse, sakeiGetSpecificRecordsFreeData};
...
{
    static SAKEIRequestInfo info = {sizeof(SAKEGetRandomRecordOutput), SAKEI_FUNC_NAME_STRINGS("GetRandomRecords"),
        sakeiGetRandomRecordValidateInput, sakeiGetRandomRecordFillSoapRequest, sakeiGetRandomRecordProcessSoapResponse,
