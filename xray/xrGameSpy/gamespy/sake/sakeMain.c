...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static SAKERequest SAKE_CALL sakeiRunRequest(SAKE sake, void* input, SAKERequestCallback callback, void* userData,
    SAKEIRequestType type, SAKEStartRequestResult (*startRequestFunc)(SAKERequest request))
{
    SAKERequest request;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeUpdateRecord(
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeDeleteRecord(
    SAKE sake, SAKEDeleteRecordInput* input, SAKERequestCallback callback, void* userData)
{
    return sakeiRunRequest(
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeSearchForRecords(
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeGetMyRecords(
...
SAKERequest SAKE_CALL sakeGetSpecificRecords(
    SAKE sake, SAKEGetSpecificRecordsInput* input, SAKERequestCallback callback, void* userData)
{
    return sakeiRunRequest(
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeGetRandomRecord(
    SAKE sake, SAKEGetRandomRecordInput* input, SAKERequestCallback callback, void* userData)
{
    return sakeiRunRequest(
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeRateRecord(
    SAKE sake, SAKERateRecordInput* input, SAKERequestCallback callback, void* userData)
{
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeGetRecordLimit(
    SAKE sake, SAKEGetRecordLimitInput* input, SAKERequestCallback callback, void* userData)
{
    return sakeiRunRequest(
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeGetRecordCount(
    SAKE sake, SAKEGetRecordCountInput* input, SAKERequestCallback callback, void* userData)
{
    return sakeiRunRequest(
...
gsi_bool SAKE_CALL sakeGetFileDownloadURL(SAKE sake, int fileId, gsi_char url[SAKE_MAX_URL_LENGTH])
{
    ...
    {
        rcode = _tsnprintf(url, SAKE_MAX_URL_LENGTH, _T("%s?gameid=%d&pid=%d"), gSakeDownloadUrlOverride, sake->mGameId,
            sake->mProfileId);
    }
    else
    {
#ifdef GSI_UNICODE
        {
            ...
            rcode = _tsnprintf(url, SAKE_MAX_URL_LENGTH,
                _T("http://%S.sake.%S/SakeFileServer/download.aspx?fileid=%d&gameid=%d&pid=%d"), sake->mGameName,
                GSI_DOMAIN_NAME, fileId, sake->mGameId, sake->mProfileId);
        }
#else
        {
            rcode = _tsnprintf(url, SAKE_MAX_URL_LENGTH,
...
gsi_bool SAKE_CALL sakeGetFileUploadURL(SAKE sake, gsi_char url[SAKE_MAX_URL_LENGTH])
{
    ...
    {
        rcode = _tsnprintf(url, SAKE_MAX_URL_LENGTH, _T("%s?gameid=%d&pid=%d"), gSakeUploadUrlOverride, sake->mGameId,
            sake->mProfileId);
    }
    else
    {
#ifdef GSI_UNICODE
        {
            // use capital %S to convert the gamename to a wide string
            rcode = _tsnprintf(url, SAKE_MAX_URL_LENGTH,
                _T("http://%S.sake.%S/SakeFileServer/upload.aspx?gameid=%d&pid=%d"), sake->mGameName, GSI_DOMAIN_NAME,
                sake->mGameId, sake->mProfileId);
        }
#else
        {
            rcode = _tsnprintf(url, SAKE_MAX_URL_LENGTH,
