...
**************/
static void AddRequestCallback(
    reqtype_t reqtype, int localid, int profileid, persisttype_t pdtype, int pdindex, void* callback, void* instance);
...
static void SetPersistDataHelper(int localid, int profileid, persisttype_t type, int index, const char* data, int len,
    PersDataSaveCallbackFn callback, void* instance, int kvset);
void GetPersistDataValuesA(
    int localid, int profileid, persisttype_t type, int index, char* keys, PersDataCallbackFn callback, void* instance);
void GetPersistDataValuesModifiedA(int localid, int profileid, persisttype_t type, int index, time_t modifiedsince,
    char* keys, PersDataCallbackFn callback, void* instance);
...
int InitStatsThink()
{
    ...
    case init_complete: return GE_NOERROR;

    default: return GE_NOCONNECT;
    };
}
...
statsgame_t NewGame(int usebuckets)
{
    ...
    {
        char respformat[] =
            "\xC\x1C\xA\x1D\x2\x2\x19\x24\x2C\x34\x6\x17\x3E\x1C\x6\xE\x39\x46\x10\x1D\x3\xD\x16\xB\x3B\x17\x16\x36\x40"
            "\x7";
...
#ifdef ALLOW_DISK
        char respformat[] =
            "\xC\x1C\xA\x1D\x2\x2\x19\x24\x2C\x34\x16\x1D\x23\x1\x4\xF\x1C\x3F\x51\x25\x2C\xB\xD\x19\x3C\x1E\xA\x4\x2"
            "\x6\x28\x64\x14";
...
void PreAuthenticatePlayerPartner(
    int localid, const char* authtoken, const char* challengeresponse, PersAuthCallbackFn callback, void* instance)
{
    char respformat[] =
        "\xC\x13\x1A\x1E\xD\x13\x28\x1D\x11\x1D\x11\x10\x24\x1D\x04\x0F\x0B\x3F\x51\x32\x2C\x1A\x00\x0B\x20\x2E\x4A\x19"
        "\x39\x0F\x1D\x25\x2C\x4D\x01";
...
void PreAuthenticatePlayerPM(
    int localid, int profileid, const char* challengeresponse, PersAuthCallbackFn callback, void* instance)
{
    char respformat[] =
...
/****************************************************************************/
void PreAuthenticatePlayerCDA(int localid, const char* nick, const char* keyhash, const char* challengeresponse,
    PersAuthCallbackFn callback, void* instance)
{
    char respformat[] =
        "\xC\x13\x1A\x1E\xD\x13\x28\x1D\x1E\x1\x6\x13\xC\x57\x1C\x36\xE\x6\xD\x29\x11\x1B\xD\x24\x75\x1\x33\x18\x0\x10"
...
#ifdef GSI_UNICODE
void PreAuthenticatePlayerCDW(int localid, const unsigned short* nick, const char* keyhash,
...
{
    char respformat[] =
        "\xC\x15\xA\x1E\x15\xA\x10\x1D\x2C\x6\xC\x1B\x3B\x2E\x4A\x19\x39\x8\x11\x38\x18\x9\x16\x10\xC\x57\x1C\x36\x9\xA"
        "\x10\x1D\x55\xC";
...
#ifdef GSI_UNICODE
void GetProfileIDFromCDW(
    int localid, const unsigned short* nick, const char* keyhash, ProfileCallbackFn callback, void* instance)
{
    char* nick_A = UCS2ToUTF8StringAlloc(nick);
...
/****************************************************************************/
void GetPersistData(
    int localid, int profileid, persisttype_t type, int index, PersDataCallbackFn callback, void* instance)
{
    GetPersistDataValuesModifiedA(localid, profileid, type, index, 0, "", callback, instance);
}

void GetPersistDataModified(int localid, int profileid, persisttype_t type, int index, time_t modifiedsince,
...
/****************************************************************************/
void SetPersistData(int localid, int profileid, persisttype_t type, int index, const char* data, int len,
...
{
    char respformat[] =
        "\xC\x15\xA\x1E\x15\x7\x28\x1D\x0\x1\x1\x24\x75\x16\x33\x1A\x11\x1A\x4\x24\x2C\x4D\x1\x24\x34\x1B\x1\xE\x0\x1B"
        "\x28\x64\x14\x34\xE\x1D\x29\x1\x33\x4F\x16\x3F\x18\x28\x14\x34\x40\x1C";
...
void GetPersistDataValuesModifiedW(int localid, int profileid, persisttype_t type, int index, time_t modifiedsince,
    unsigned short* keys, PersDataCallbackFn callback, void* instance)
{
...
#ifdef GSI_UNICODE
void GetPersistDataValuesW(int localid, int profileid, persisttype_t type, int index, unsigned short* keys,
    PersDataCallbackFn callback, void* instance)
{
...
/****************************************************************************/
void SetPersistDataValuesA(int localid, int profileid, persisttype_t type, int index, const char* keyvalues,
    PersDataSaveCallbackFn callback, void* instance)
{
    SetPersistDataHelper(localid, profileid, type, index, keyvalues, (int)strlen(keyvalues) + 1, callback, instance, 1);
}
#ifdef GSI_UNICODE
void SetPersistDataValuesW(int localid, int profileid, persisttype_t type, int index, const unsigned short* keyvalues,
    PersDataSaveCallbackFn callback, void* instance)
{
...
static int SendChallengeResponse(const char* indata, int gameport)
{
    ...
    char respformat[] =
        "\xC\x13\x1A\x1E\xD\x3F\x28\x26\x11\x5\x0\x16\x31\x1F\xA\x36\x40\x10\x28\x33\x15\x1B\x15\x17\x3E\x1\xA\x36\x40"
...
{
    char respformat[] =
        "\xC\x1\xA\x1E\x15\x7\x28\x1D\x0\x1\x1\x24\x75\x16\x33\x1A\x11\x1A\x4\x24\x2C\x4D\x1\x24\x34\x1B\x1\xE\x0\x1B"
        "\x28\x64\x14\x34\xE\xE\xC\x57\xB\x36\x9\xA\x10\x1D\x55\xC\x39\x14\x35\x1C\x8\x1E\xD\x3F\x51\x25\x2C\xC\x4\xC"
        "\x31\x2E";
...
static void CallReqCallback(int reqindex, int success, time_t modified, char* data, int length)
{
    ...
    if (req->callback)
...
#else
        {
            ...
            break;
        case rt_datacb:
            ((PersDataCallbackFn)req->callback)(req->localid, req->profileid, req->pdtype, req->pdindex, success,
...
static char* CreateBucketSnapShot(bucketset_t buckets) { return DumpBucketSet(buckets); }
