...
GPResult gpConnectA(GPConnection* connection, const char nick[GP_NICK_LEN], const char email[GP_EMAIL_LEN],
    const char password[GP_PASSWORD_LEN], GPEnum firewall, GPEnum blocking, GPCallback callback, void* param)
{
    GPIConnection* iconnection;
...
#ifdef GSI_UNICODE
GPResult gpConnectW(GPConnection* connection, const unsigned short nick[GP_NICK_LEN],
    const unsigned short email[GP_EMAIL_LEN], const unsigned short password[GP_PASSWORD_LEN], GPEnum firewall,
...
GPResult gpConnectNewUserA(GPConnection* connection, const char nick[GP_NICK_LEN],
    const char uniquenick[GP_UNIQUENICK_LEN], const char email[GP_EMAIL_LEN], const char password[GP_PASSWORD_LEN],
    const char cdkey[GP_CDKEY_LEN], GPEnum firewall, GPEnum blocking, GPCallback callback, void* param)
{
    GPIConnection* iconnection;
...
#ifdef GSI_UNICODE
GPResult gpConnectNewUserW(GPConnection* connection, const unsigned short nick[GP_NICK_LEN],
    const unsigned short uniquenick[GP_UNIQUENICK_LEN], const unsigned short email[GP_EMAIL_LEN],
    const unsigned short password[GP_PASSWORD_LEN], const unsigned short cdkey[GP_CDKEY_LEN], GPEnum firewall,
    GPEnum blocking, GPCallback callback, void* param)
{
    char nick_A[GP_NICK_LEN];
...
GPResult gpConnectUniqueNickA(GPConnection* connection, const char uniquenick[GP_UNIQUENICK_LEN],
    const char password[GP_PASSWORD_LEN], GPEnum firewall, GPEnum blocking, GPCallback callback, void* param)
{
    GPIConnection* iconnection;
...
#ifdef GSI_UNICODE
GPResult gpConnectUniqueNickW(GPConnection* connection, const unsigned short uniquenick[GP_UNIQUENICK_LEN],
    const unsigned short password[GP_PASSWORD_LEN], GPEnum firewall, GPEnum blocking, GPCallback callback, void* param)
{
    char uniquenick_A[GP_UNIQUENICK_LEN];
    char password_A[GP_NICK_LEN];
...
GPResult gpConnectPreAuthenticatedA(GPConnection* connection, const char authtoken[GP_AUTHTOKEN_LEN],
    const char partnerchallenge[GP_PARTNERCHALLENGE_LEN], GPEnum firewall, GPEnum blocking, GPCallback callback,
    void* param)
{
    GPIConnection* iconnection;
...
#ifdef GSI_UNICODE
GPResult gpConnectPreAuthenticatedW(GPConnection* connection, const unsigned short authtoken[GP_AUTHTOKEN_LEN],
    const unsigned short partnerchallenge[GP_PARTNERCHALLENGE_LEN], GPEnum firewall, GPEnum blocking,
...
GPResult gpCheckUserA(GPConnection* connection, const char nick[GP_NICK_LEN], const char email[GP_EMAIL_LEN],
    const char password[GP_PASSWORD_LEN], GPEnum blocking, GPCallback callback, void* param)
{
    GPIConnection* iconnection;
...
GPResult gpCheckUserW(GPConnection* connection, const unsigned short nick[GP_NICK_LEN],
    const unsigned short email[GP_EMAIL_LEN], const unsigned short password[GP_PASSWORD_LEN], GPEnum blocking,
    GPCallback callback, void* param)
{
    char nick_A[GP_NICK_LEN];
    char email_A[GP_NICK_LEN];
...
GPResult gpNewUserA(GPConnection* connection, const char nick[GP_NICK_LEN], const char uniquenick[GP_UNIQUENICK_LEN],
    const char email[GP_EMAIL_LEN], const char password[GP_PASSWORD_LEN], const char cdkey[GP_CDKEY_LEN],
    GPEnum blocking, GPCallback callback, void* param)
{
    GPIConnection* iconnection;
...
GPResult gpNewUserW(GPConnection* connection, const unsigned short nick[GP_NICK_LEN],
    const unsigned short uniquenick[GP_UNIQUENICK_LEN], const unsigned short email[GP_EMAIL_LEN],
    const unsigned short password[GP_PASSWORD_LEN], const unsigned short cdkey[GP_CDKEY_LEN], GPEnum blocking,
    GPCallback callback, void* param)
{
    char nick_A[GP_NICK_LEN];
    char uniquenick_A[GP_UNIQUENICK_LEN];
...
GPResult gpSuggestUniqueNickA(
    GPConnection* connection, const char desirednick[GP_NICK_LEN], GPEnum blocking, GPCallback callback, void* param)
{
    GPIConnection* iconnection;
...
#ifdef GSI_UNICODE
GPResult gpSuggestUniqueNickW(GPConnection* connection, const unsigned short desirednick[GP_NICK_LEN], GPEnum blocking,
    GPCallback callback, void* param)
{
...
GPResult gpRegisterUniqueNickA(GPConnection* connection, const char uniquenick[GP_UNIQUENICK_LEN],
    const char cdkey[GP_CDKEY_LEN], GPEnum blocking, GPCallback callback, void* param)
{
    GPIConnection* iconnection;
...
#ifdef GSI_UNICODE
GPResult gpRegisterUniqueNickW(GPConnection* connection, const unsigned short uniquenick[GP_UNIQUENICK_LEN],
    const unsigned short cdkey[GP_CDKEY_LEN], GPEnum blocking, GPCallback callback, void* param)
{
    char uniquenick_A[GP_UNIQUENICK_LEN];
    char cdkey_A[GP_CDKEY_LEN];
...
GPResult gpRegisterCdKeyA(
    GPConnection* connection, const char cdkey[GP_CDKEY_LEN], GPEnum blocking, GPCallback callback, void* param)
{
    GPIConnection* iconnection;
...
GPResult gpRegisterCdKeyW(
    GPConnection* connection, const gsi_char cdkey[GP_CDKEY_LEN], GPEnum blocking, GPCallback callback, void* param)
{
    char cdkey_A[GP_CDKEY_LEN];
    UCS2ToAsciiString(cdkey, cdkey_A);
...
GPResult gpNewProfileA(GPConnection* connection, const char nick[GP_NICK_LEN], GPEnum replace, GPEnum blocking,
    GPCallback callback, void* param)
{
    GPIConnection* iconnection;
...
#ifdef GSI_UNICODE
GPResult gpNewProfileW(GPConnection* connection, const unsigned short nick[GP_NICK_LEN], GPEnum replace,
    GPEnum blocking, GPCallback callback, void* param)
{
    char nick_A[GP_NICK_LEN];
...
GPResult gpProfileSearchA(GPConnection* connection, const char nick[GP_NICK_LEN],
    const char uniquenick[GP_UNIQUENICK_LEN], const char email[GP_EMAIL_LEN], const char firstname[GP_FIRSTNAME_LEN],
    const char lastname[GP_LASTNAME_LEN], int icquin, GPEnum blocking, GPCallback callback, void* param)
{
    GPIConnection* iconnection;
...
GPResult gpProfileSearchW(GPConnection* connection, const unsigned short nick[GP_NICK_LEN],
    const unsigned short uniquenick[GP_UNIQUENICK_LEN], const unsigned short email[GP_EMAIL_LEN],
    const unsigned short firstname[GP_FIRSTNAME_LEN], const unsigned short lastname[GP_LASTNAME_LEN], int icquin,
    GPEnum blocking, GPCallback callback, void* param)
{
    char nick_A[GP_NICK_LEN];
    char uniquenick_A[GP_UNIQUENICK_LEN];
...
GPResult gpProfileSearchUniquenickA(GPConnection* connection, const char uniquenick[GP_UNIQUENICK_LEN],
    const int namespaceIDs[GP_MAX_NAMESPACEIDS], int numNamespaces, GPEnum blocking, GPCallback callback, void* param)
{
    GPIConnection* iconnection;
...
#ifdef GSI_UNICODE
GPResult gpProfileSearchUniquenickW(GPConnection* connection, const unsigned short uniquenick[GP_UNIQUENICK_LEN],
    const int namespaceIDs[GP_MAX_NAMESPACEIDS], int numNamespaces, GPEnum blocking, GPCallback callback, void* param)
{
    char uniquenick_A[GP_UNIQUENICK_LEN];
...
GPResult gpGetInfo(
    GPConnection* connection, GPProfile profile, GPEnum checkCache, GPEnum blocking, GPCallback callback, void* param)
{
    GPIConnection* iconnection;
...
#ifndef GP_NEW_STATUS_INFO
GPResult gpSetStatusA(GPConnection* connection, GPEnum status, const char statusString[GP_STATUS_STRING_LEN],
...
#ifdef GP_NEW_STATUS_INFO
GPResult gpSetStatusInfoA(GPConnection* connection, GPEnum statusState, unsigned int hostIp, unsigned int hostPrivateIp,
    unsigned short queryPort, unsigned short hostPort, unsigned int sessionFlags, const char* richStatus,
    int richStatusLen, const char* gameType, int gameTypeLen, const char* gameVariant, int gameVariantLen,
    const char* gameMapName, int gameMapNameLen)
{
    GPIConnection* iconnection;
...
#ifdef GSI_UNICODE
GPResult gpSetStatusInfoW(GPConnection* connection, GPEnum statusState, unsigned int hostIp, unsigned int hostPrivateIp,
    unsigned short queryPort, unsigned short hostPort, unsigned int sessionFlags, const unsigned short* richStatus,
    int richStatusLen, const unsigned short* gameType, int gameTypeLen, const unsigned short* gameVariant,
    int gameVariantLen, const unsigned short* gameMapName, int gameMapNameLen)
{
    ...
    aResult = gpSetStatusInfoA(connection, statusState, hostIp, hostPrivateIp, queryPort, hostPort, sessionFlags,
        richStatus_A, (int)strlen(richStatus_A), gameType_A, (int)strlen(gameType_A), gameVariant_A,
        (int)strlen(gameVariant_A), gameMapName_A, (int)strlen(gameMapName_A));
...
GPResult gpGetBuddyStatusInfoKeys(GPConnection* connection, int index, GPCallback callback, void* userData)
{
    ...
    if (pProfile->buddyStatus)
        CallbackError(connection, GP_PARAMETER_ERROR, GP_BM_EXT_INFO_NOT_SUPPORTED,
            ...
            if (!pProfile->buddyStatusInfo && !pProfile->buddyStatus) CallbackError(connection, GP_PARAMETER_ERROR,
                GP_BM_NOT_BUDDY, "The profile used to get extended info keys is not a buddy.")
...
GPResult gpIsValidEmailA(
    GPConnection* connection, const char email[GP_EMAIL_LEN], GPEnum blocking, GPCallback callback, void* param)
{
    GPIConnection* iconnection;
...
#ifdef GSI_UNICODE
GPResult gpIsValidEmailW(GPConnection* connection, const unsigned short email[GP_EMAIL_LEN], GPEnum blocking,
    GPCallback callback, void* param)
{
    char email_A[GP_EMAIL_LEN];
    UCS2ToAsciiString(email, email_A);
...
GPResult gpGetUserNicksA(GPConnection* connection, const char email[GP_EMAIL_LEN], const char password[GP_PASSWORD_LEN],
    GPEnum blocking, GPCallback callback, void* param)
{
    GPIConnection* iconnection;
...
#ifdef GSI_UNICODE
GPResult gpGetUserNicksW(GPConnection* connection, const unsigned short email[GP_EMAIL_LEN],
    const unsigned short password[GP_PASSWORD_LEN], GPEnum blocking, GPCallback callback, void* param)
{
    char email_A[GP_EMAIL_LEN];
    char password_A[GP_PASSWORD_LEN];
    UCS2ToAsciiString(email, email_A);
...
GPResult gpInvitePlayerA(
    GPConnection* connection, GPProfile profile, int productID, const char location[GP_LOCATION_STRING_LEN])
{
    GPIConnection* iconnection;
...
GPResult gpInvitePlayerW(
    GPConnection* connection, GPProfile profile, int productID, const gsi_char location[GP_LOCATION_STRING_LEN])
{
...
GPResult gpGetReversBuddiesList(
    GPConnection* connection, GPProfile* targets, int numOfTargets, GPEnum blocking, GPCallback callback, void* param)
{
    GPIConnection* iconnection;
...
#ifndef NOFILE
void gpSetInfoCacheFilenameA(const char* filename) { gpiSetInfoCacheFilename(filename); }
...
static GPResult gpiAddSendingFileW(
    GPConnection* connection, GPITransfer* transfer, const unsigned short* path, const unsigned short* name)
{
...
GPResult gpSendFilesA(GPConnection* connection, GPTransfer* transfer, GPProfile profile, const char* message,
...
GPResult gpSendFilesW(GPConnection* connection, GPTransfer* transfer, GPProfile profile, const unsigned short* message,
    gpSendFilesCallback callback, void* param)
{
    char* message_A = NULL;
    GPResult result;
