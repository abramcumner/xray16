...
GPResult gpiSetInfoi(GPConnection* connection, GPEnum info, int value)
{
    ...
    case GP_SEX:
        ...
        switch (value)
        {
        case GP_MALE: CHECK_RESULT(gpiSendLocalInfo(connection, "\\sex\\", "0")); break;

        case GP_FEMALE: CHECK_RESULT(gpiSendLocalInfo(connection, "\\sex\\", "1")); break;

        case GP_PAT: CHECK_RESULT(gpiSendLocalInfo(connection, "\\sex\\", "2")); break;

        default: Error(connection, GP_PARAMETER_ERROR, "Invalid sex.");
        }
    ...
    default: Error(connection, GP_PARAMETER_ERROR, "Invalid info.");
    }
...
GPResult gpiSetInfos(GPConnection* connection, GPEnum info, const char* value)
{
    ...
    case GP_CPUSPEED: CHECK_RESULT(gpiSetInfoi(connection, GP_CPUSPEED, atoi(value))); break;

    case GP_MEMORY: CHECK_RESULT(gpiSetInfoi(connection, GP_MEMORY, atoi(value))); break;
    ...
    case GP_VIDEOCARD1RAM: CHECK_RESULT(gpiSetInfoi(connection, GP_VIDEOCARD1RAM, atoi(value))); break;
    ...
    case GP_VIDEOCARD2RAM: CHECK_RESULT(gpiSetInfoi(connection, GP_VIDEOCARD2RAM, atoi(value))); break;

    case GP_CONNECTIONSPEED: CHECK_RESULT(gpiSetInfoi(connection, GP_CONNECTIONSPEED, atoi(value))); break;

    case GP_HASNETWORK: CHECK_RESULT(gpiSetInfoi(connection, GP_HASNETWORK, atoi(value))); break;
