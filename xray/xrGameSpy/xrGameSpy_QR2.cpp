...
XRGAMESPY_API const char* xrGS_RegisteredKey(DWORD KeyID) { return qr2_registered_key_list[KeyID]; };

XRGAMESPY_API void xrGS_qr2_register_keyA(int keyid, const gsi_char* key) { qr2_register_keyA(keyid, key); }

XRGAMESPY_API void xrGS_qr2_think(qr2_t qrec) { qr2_think(qrec); };

XRGAMESPY_API void xrGS_qr2_shutdown(qr2_t qrec) { qr2_shutdown(qrec); };

XRGAMESPY_API void xrGS_qr2_buffer_addA(qr2_buffer_t outbuf, const char* value) { qr2_buffer_addA(outbuf, value); };
...
XRGAMESPY_API void xrGS_qr2_register_denyresponsetoip_callback(
    qr2_t qrec, qr2_denyqr2responsetoipcallback_t dertoipcallback)
{
...
XRGAMESPY_API qr2_error_t xrGS_qr2_initA(/*[out]*/ qr2_t* qrec, const gsi_char* ip, int baseport, int ispublic,
    int natnegotiate, qr2_serverkeycallback_t server_key_callback, qr2_playerteamkeycallback_t player_key_callback,
