...
//	EXPORT_FN_DECL(qr2_error_t, qr2_init, (/*[out]*/qr2_t *qrec, const gsi_char *ip, int baseport, const gsi_char
//*gamename, const gsi_char *secret_key,
EXPORT_FN_DECL(qr2_error_t, qr2_initA,
    (/*[out]*/ qr2_t * qrec, const gsi_char* ip, int baseport, int ispublic, int natnegotiate,
