...
XRGAMESPY_API void xrGS_ghttpStartup() { ghttpStartup(); }

XRGAMESPY_API void xrGS_ghttpCleanup() { ghttpCleanup(); }

XRGAMESPY_API void xrGS_ghttpThink() { ghttpThink(); }
...
XRGAMESPY_API void xrGS_ghttpCancelRequest(GHTTPRequest request) { ghttpCancelRequest(request); };