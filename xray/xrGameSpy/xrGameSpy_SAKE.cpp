...
XRGAMESPY_API void xrGS_sakeShutdown(SAKE sake) { sakeShutdown(sake); }
...
XRGAMESPY_API SAKERequest xrGS_sakeGetMyRecords(
...
XRGAMESPY_API SAKERequest xrGS_sakeCreateRecord(
...
XRGAMESPY_API SAKERequest xrGS_sakeUpdateRecord(
...
XRGAMESPY_API SAKERequest xrGS_sakeSearchForRecords(
