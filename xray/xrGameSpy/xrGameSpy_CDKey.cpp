...
XRGAMESPY_API int xrGS_gcd_init_qr2(qr2_t qrec) { return gcd_init_qr2(qrec, GAMESPY_GAMEID); };
XRGAMESPY_API void xrGS_gcd_shutdown(void) { gcd_shutdown(); }
...
XRGAMESPY_API void xrGS_gcd_disconnect_user(int localid) { gcd_disconnect_user(GAMESPY_GAMEID, localid); }
XRGAMESPY_API void xrGS_gcd_think(void) { gcd_think(); }

XRGAMESPY_API char* xrGS_gcd_getkeyhash(int localid) { return gcd_getkeyhash(GAMESPY_GAMEID, localid); }