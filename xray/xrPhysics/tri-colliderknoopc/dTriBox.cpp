...
#define TEST(ax, ox, c)                                                                                                \
    ...
    // const dReal* hside, const dReal* p,  const dReal* triSideAx, const dReal* vax,   const dReal* vox  ) if(
    // test_cross_side (outAx,outDepth,pos,signum,code,10,R,hside,p,triSideAx0,v0,v2) )
    //  return 0;
    TEST(0, 2, 10)
    TEST(1, 0, 13)
    TEST(2, 1, 16)
