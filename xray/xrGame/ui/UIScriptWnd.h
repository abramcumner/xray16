...
public:
	...
	virtual						~CUIDialogWndEx		();
			void				AddCallback			(LPCSTR control_id, s16 event, const luabindex::functor<void> &lua_function);
			void				AddCallback			(LPCSTR control_id, s16 event, const luabindex::functor<void> &functor, const luabind::object &object);
	virtual void				Update				();
