...
int FactionState::get_actor_goodwill() const { return m_actor_goodwill; }
void FactionState::set_actor_goodwill(int gw) { m_actor_goodwill = gw; }
LPCSTR FactionState::get_faction_id() const { return m_id.c_str(); }
shared_str const& FactionState::get_faction_id2() const { return m_id; }
void FactionState::set_faction_id(LPCSTR id) { m_id._set(id); }
void FactionState::set_faction_id2(shared_str const& id) { m_id._set(id); }
LPCSTR FactionState::get_name() const { return m_name.c_str(); }
void FactionState::set_name(LPCSTR name) { m_name._set(name); }
LPCSTR FactionState::get_icon() const { return m_icon.c_str(); }
void FactionState::set_icon(LPCSTR icon) { m_icon._set(icon); }

LPCSTR FactionState::get_icon_big() const { return m_icon_big.c_str(); }
void FactionState::set_icon_big(LPCSTR icon_b) { m_icon_big._set(icon_b); }

LPCSTR FactionState::get_target() const { return m_target.c_str(); }
void FactionState::set_target(LPCSTR target) { m_target._set(target); }

LPCSTR FactionState::get_target_desc() const { return m_target_desc.c_str(); }
void FactionState::set_target_desc(LPCSTR target_desc) { m_target_desc._set(target_desc); }

LPCSTR FactionState::get_location() const { return m_location.c_str(); }
void FactionState::set_location(LPCSTR location) { m_location._set(location); }
