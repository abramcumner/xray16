...
CUIRankFraction::CUIRankFraction(shared_str const& fraction_id) : m_fraction_state(fraction_id) {}

CUIRankFraction::~CUIRankFraction() {}

float CUIRankFraction::get_fraction_power() { return m_fraction_state.power; }
