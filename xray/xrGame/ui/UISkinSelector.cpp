...
CUISkinSelectorWnd::CUISkinSelectorWnd(const char* strSectionName, s16 team)
{
    ...
    //	m_pButtons[0]	= xr_new<CUI3tButton>();	m_pFrames->AttachChild(m_pButtons[0]);
    //m_pButtons[0]->SetMessageTarget(this); 	m_pButtons[1]	= xr_new<CUI3tButton>();
    //m_pFrames->AttachChild(m_pButtons[1]); m_pButtons[1]->SetMessageTarget(this);
