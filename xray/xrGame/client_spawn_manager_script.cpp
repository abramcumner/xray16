...
void CClientSpawnManager::script_register(lua_State *L)
{
	...
	[
		class_<CClientSpawnManager>("client_spawn_manager")
			.def("add",		(void (CClientSpawnManager::*)(ALife::_OBJECT_ID,ALife::_OBJECT_ID,const luabindex::functor<void> &, const luabind::object &))(&CClientSpawnManager::add))
			.def("add",		(void (CClientSpawnManager::*)(ALife::_OBJECT_ID,ALife::_OBJECT_ID,const luabindex::functor<void> &))(&CClientSpawnManager::add))
