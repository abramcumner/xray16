...
{
	luabindex::functor<bool>			*m_lua_function;

							CPHScriptCondition				(const CPHScriptCondition &func);

public:
							CPHScriptCondition				(const luabindex::functor<bool> &func)	;
...
public:
							CPHScriptAction					(const luabindex::functor<void> &func)	;
...
public:
	CPHScriptObjectConditionN			( const luabind::object &object,const luabindex::functor<bool> &functor)	;
...
public:
	CPHScriptObjectActionN			( const luabind::object &object,const luabindex::functor<void> &functor);
	...
	public CPHScriptObjectConditionN
{
	...
	bool	 b_obsolete;
public:
	CPHScriptGameObjectCondition( const luabind::object &object,const luabindex::functor<bool> &functor,CObject* gobj):
	...
	public CPHScriptObjectActionN
{
	CObject* m_obj;
public:
	CPHScriptGameObjectAction( const luabind::object &object,const luabindex::functor<void> &functor,CObject* gobj):
