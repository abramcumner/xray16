...
IC	bool CScriptEngine::functor(LPCSTR function_to_call, luabindex::functor<_result_type> &lua_function)
{
	...
	try {
		lua_function		= luabind::object_cast<luabindex::functor<_result_type> >(object);
	}
	catch(...) {
		return				(false);
	}
