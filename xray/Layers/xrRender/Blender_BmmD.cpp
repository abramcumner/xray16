...
void CBlender_BmmD::Compile(CBlender_Compile& C)
{
    ...
    case SE_R2_NORMAL_HQ: // deffer
        ...
        // D3DTEXF_ANISOTROPIC); C.r_Sampler		("s_dt_g",	oG_Name,	false,	D3DTADDRESS_WRAP,
        // D3DTEXF_ANISOTROPIC,D3DTEXF_LINEAR,	D3DTEXF_ANISOTROPIC); C.r_Sampler		("s_dt_b",	oB_Name,	false,
        // D3DTADDRESS_WRAP,	D3DTEXF_ANISOTROPIC,D3DTEXF_LINEAR,	D3DTEXF_ANISOTROPIC); C.r_Sampler		("s_dt_a",
        // oA_Name,	false,	D3DTADDRESS_WRAP,	D3DTEXF_ANISOTROPIC,D3DTEXF_LINEAR,	D3DTEXF_ANISOTROPIC);
