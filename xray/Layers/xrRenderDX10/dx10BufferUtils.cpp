...
VertexFormatPairs VertexFormatList[] = {{D3DDECLTYPE_FLOAT1, DXGI_FORMAT_R32_FLOAT},
    ...
    {D3DDECLTYPE_UBYTE4,
        DXGI_FORMAT_R8G8B8A8_UINT}, // Note: Shader gets UINT values, but if Direct3D 9 style integral floats are needed
                                    // (0.0f, 1.0f... 255.f), UINT can just be converted to float32 in shader.
    {D3DDECLTYPE_SHORT2,
    ...
    {D3DDECLTYPE_UBYTE4N, DXGI_FORMAT_R8G8B8A8_UNORM}, {D3DDECLTYPE_SHORT2N, DXGI_FORMAT_R16G16_SNORM},
    {D3DDECLTYPE_SHORT4N, DXGI_FORMAT_R16G16B16A16_SNORM}, {D3DDECLTYPE_USHORT2N, DXGI_FORMAT_R16G16_UNORM},
