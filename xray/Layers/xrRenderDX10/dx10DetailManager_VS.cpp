...
void CDetailManager::hw_Render()
{
    ...
    // // consts RCache.set_c			(&*hwc_wave,	wave.div(PI_MUL_2));	// wave RCache.set_c
    // (&*hwc_wind, dir1);																					// wind-dir
    ...
    // RCache.set_c			(&*hwc_wind,	dir2); // wind-dir hw_Render_dump			(&*hwc_array,	2, 0, c_hdr );
