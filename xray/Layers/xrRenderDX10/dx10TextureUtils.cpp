...
TextureFormatPairs TextureFormatList[] = {
    ...
    // D3DFMT_R8G8_B8G8 DXGI_FORMAT_G8R8_G8B8_UNORM (in DX9 the data was scaled up by 255.0f, but this can be
    // handled in shader code). D3DFMT_YUY2 Not available D3DFMT_G8R8_G8B8 DXGI_FORMAT_R8G8_B8G8_UNORM (in DX9 the
    // data was scaled up by 255.0f, but this can be handled in shader code). D3DFMT_DXT1 DXGI_FORMAT_BC1_UNORM &
    // DXGI_FORMAT_BC1_UNORM_SRGB D3DFMT_DXT2 DXGI_FORMAT_BC1_UNORM & DXGI_FORMAT_BC1_UNORM_SRGB Note: DXT1 and DXT2
    // are the same from an API/hardware perspective... only difference was 'premultiplied alpha', which can be
    // tracked by an application and doesn't need a separate format. D3DFMT_DXT3 DXGI_FORMAT_BC2_UNORM &
    // DXGI_FORMAT_BC2_UNORM_SRGB D3DFMT_DXT4 DXGI_FORMAT_BC2_UNORM & DXGI_FORMAT_BC2_UNORM_SRGB Note: DXT3 and DXT4
    // are the same from an API/hardware perspective... only difference was 'premultiplied alpha', which can be
    // tracked by an application and doesn't need a separate format. D3DFMT_DXT5 DXGI_FORMAT_BC3_UNORM &
    // DXGI_FORMAT_BC3_UNORM_SRGB D3DFMT_D16 & D3DFMT_D16_LOCKABLE DXGI_FORMAT_D16_UNORM D3DFMT_D32 Not available
    ...
    // D3DFMT_L16 DXGI_FORMAT_R16_UNORM Note: Use .r swizzle in shader to duplicate red to other components to get
    // D3D9 behavior. D3DFMT_INDEX16 DXGI_FORMAT_R16_UINT D3DFMT_INDEX32 DXGI_FORMAT_R32_UINT D3DFMT_Q16W16V16U16
    // DXGI_FORMAT_R16G16B16A16_SNORM D3DFMT_MULTI2_ARGB8 Not available D3DFMT_R16F DXGI_FORMAT_R16_FLOAT
    ...
    // floats are needed (0.0f, 1.0f... 255.f), UINT can just be converted to float32 in shader. D3DDECLTYPE_SHORT2
    // DXGI_FORMAT_R16G16_SINT Note: Shader gets SINT values, but if Direct3D 9 style integral floats are needed,
    // SINT can just be converted to float32 in shader. D3DDECLTYPE_SHORT4 DXGI_FORMAT_R16G16B16A16_SINT Note:
    // Shader gets SINT values, but if Direct3D 9 style integral floats are needed, SINT can just be converted to
    // float32 in shader. D3DDECLTYPE_UBYTE4N DXGI_FORMAT_R8G8B8A8_UNORM D3DDECLTYPE_SHORT2N
    // DXGI_FORMAT_R16G16_SNORM D3DDECLTYPE_SHORT4N DXGI_FORMAT_R16G16B16A16_SNORM D3DDECLTYPE_USHORT2N
    // DXGI_FORMAT_R16G16_UNORM D3DDECLTYPE_USHORT4N DXGI_FORMAT_R16G16B16A16_UNORM D3DDECLTYPE_UDEC3 Not available
