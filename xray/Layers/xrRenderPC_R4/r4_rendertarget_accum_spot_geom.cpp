...
void CRenderTarget::accum_spot_geom_create()
{
    ...
    // Indices
    {
        ...
        // BYTE*	pData		= 0;
        // R_CHK
        // (HW.pDevice->CreateIndexBuffer(iCount*2,dwUsage,D3DFMT_INDEX16,D3DPOOL_MANAGED,&g_accum_spot_ib,0)); R_CHK
        // (g_accum_spot_ib->Lock(0,0,(void**)&pData,0)); CopyMemory		(pData,du_cone_faces,iCount*2);
