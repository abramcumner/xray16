...
//Device.dwFrame);
    ...
    //	Msg							("[%d][0x%08x]IAmNotACrowAnyMore (CObjectList::SingleUpdate)", Device.dwFrame,
    //dynamic_cast<void*>(O));
...
void CObjectList::clear_crow_vec(Objects& o)
{
    ...
    {
        //		Msg				("[%d][0x%08x]IAmNotACrowAnyMore (clear_crow_vec)", Device.dwFrame,
        //dynamic_cast<void*>(o[_it]));
