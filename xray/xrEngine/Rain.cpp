...
CEffect_Rain::CEffect_Rain()
{
    ...
    hGeom_Drops.create				(D3DFVF_XYZ | D3DFVF_DIFFUSE | D3DFVF_TEX1, RCache.Vertex.Buffer(),
    RCache.Index.Buffer());
    */
    p_create();
    // FS.r_close						(F);
...
(vCount_Lock, hGeom_Drops->vb_stride, v_offset); u16*					i_ptr			= _IS.Lock
...
(vCount_Lock, hGeom_Drops->vb_stride, v_offset); i_ptr					= _IS.Lock
